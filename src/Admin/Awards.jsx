...
const Awards = () => {
  ...
  const deleteBlog = async (id) => {
    try {
      await axios.delete(`${process.env.REACT_APP_API_URL}/api/awards/${id}`);
  ...
  const onSubmit = async (data) => {
    try {
      ...
      const url = selectedBlog
        ? `${process.env.REACT_APP_API_URL}/api/awards/${selectedBlog._id}`
  ...
  return (
    <div className="our-blogs-container">
      ...
      >
        {showForm ? "Close awards Form" : "Add New awards"}
      </button>
